...
class Settings extends Base {
    ...
    public function admin_notices() {
        ...
        ?>
        <div class="notice notice-success image_sizes-notice cx-shadow">
        	<?php if( $version_updated ) echo '<i class="notice-dismiss image_sizes-dismiss" data-meta_key="image-sizes_regened"></i>'; ?>
