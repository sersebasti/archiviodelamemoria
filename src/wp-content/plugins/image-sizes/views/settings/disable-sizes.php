	...
	<div id="check-wrap">
		...
		<div id="check-all-wrap">
			...
			<label class="image_sizes-switch">
			  <input type="checkbox" id="check-all" class="checkbox check-all image_sizes-switch-checkbox">
		...
		<div id="check-default-wrap">
			...
			<label class="image_sizes-switch">
			  <input type="checkbox" id="check-default" class="checkbox check-all-default image_sizes-switch-checkbox">
			  <span class="image_sizes-slider round"></span>
			</label>
		</div>
		<div id="check-custom-wrap">
			...
			<label class="image_sizes-switch">
			  <input type="checkbox" id="check-custom" class="checkbox check-all-custom image_sizes-switch-checkbox">
			  <span class="image_sizes-slider round"></span>
			</label>
		</div>
	</div>
...
foreach ( $image_sizes as $id => $size ) {
	...
	echo "
		<tr id='row-{$id}'>
			<td class='image_sizes-switch-col'>
				<label class='image_sizes-switch'>
				  <input type='checkbox' class='checkbox check-this check-{$size['type']} image_sizes-switch-checkbox' name='disables[]' value='{$id}' {$_checked}>
				  <span class='image_sizes-slider round'></span>
				</label>
			</td>
			<td>{$id}</td>
