...
class DCE_Widget_BarCode extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    {
        $types1d = array('C39', 'C39+', 'C39E', 'C39E+', 'C93', 'S25', 'S25+', 'I25', 'I25+', 'C128', 'C128A', 'C128B', 'C128C', 'EAN2', 'EAN5', 'EAN8', 'EAN13', 'UPCA', 'UPCE', 'MSI', 'MSI+', 'POSTNET', 'PLANET', 'RMS4CC', 'KIX', 'IMB', 'IMBPRE', 'CODABAR', 'CODE11', 'PHARMA', 'PHARMA2T');
        $types2d = array(
            'DATAMATRIX',
            'PDF417',
            // string of multiple params xx,yy,zz
            'QRCODE',
            // array('L','M','Q','H') // es: QRCODE,L
            'RAW',
            'RAW2',
            'TEST',
        );
        ...
        $this->add_control('dce_barcode_code', ['label' => __('Code', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'description' => __('The value of a barcode can be an URL, a number, or a simple text', 'dynamic-content-for-elementor'), 'default' => get_bloginfo('url'), 'label_block' => \true]);
        ...
        $this->add_control('dce_barcode_rows', ['label' => __('Rows', 'dynamic-content-for-elementor'), 'type' => \Elementor\Controls_Manager::NUMBER, 'min' => 1]);
