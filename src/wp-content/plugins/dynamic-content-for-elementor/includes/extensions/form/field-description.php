...
class DCE_Extension_Form_description extends \DynamicContentForElementor\Extensions\DCE_Extension_Prototype
{
    ...
    {
        $widget->start_controls_section('section_field_description_style', ['label' => '<span class="color-dce icon icon-dyn-logo-dce pull-right ml-1"></span> ' . __('Field Description', 'dynamic-content-for-elementor'), 'tab' => Controls_Manager::TAB_STYLE]);
