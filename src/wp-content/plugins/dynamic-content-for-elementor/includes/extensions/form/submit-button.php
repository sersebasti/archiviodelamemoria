...
class DCE_Extension_Form_Submit extends \ElementorPro\Modules\Forms\Fields\Field_Base
{
    ...
    public function render($item, $item_index, $form)
    {
        ...
        if (!empty($item['button_size'])) {
            $form->add_render_attribute('button' . $item_index, 'class', 'elementor-size-' . $item['button_size']);
        }
        if (!empty($item['button_type'])) {
            $form->add_render_attribute('button' . $item_index, 'class', 'elementor-button-' . $item['button_type']);
        }
        if (!empty($item['button_hover_animation'])) {
            $form->add_render_attribute('button' . $item_index, 'class', 'elementor-animation-' . $item['button_hover_animation']);
        }
        ?>
